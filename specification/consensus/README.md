# Aeternity consensus protocol

This document defines the aeternity consensus protocol.
...
contains the initial state of the aeternity blockchain. Part of initial state
is generated from the distribution of the aeternity ERC20 token on the
Ethereum blockchain.
...
Aeternity follows the "fat protocol" approach, which means that the protocol
