...
is generated from the distribution of the Æternity ERC20 token on the Ethereum blockchain
at a given cut-off point. Genesis block is a Key Block and initial state is expressed in state trees.
...
being solved is that of finding cycles in a bipartite graph. Proof-of-Work is used to elect a leader. It is applied to Key Blocks.
