...
**Note:** When signing the inner transaction the network id should be extended to `<network id>-inner_tx` in order to make the inner transaction not replayable on-chain.
